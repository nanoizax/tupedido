...
public class RecyclerViewAdapterHorizontal extends RecyclerView.Adapter<RecyclerViewAdapterHorizontal.ViewHolder> {
    ...
    public RecyclerViewAdapterHorizontal(Context context, ArrayList<String> names, ArrayList<String> imageUrls, ArrayList<String> id, ArrayList<String> precio, ArrayList<String> descripcion, ArrayList<String> cantidad, ArrayList<String> latitud, ArrayList<String> longitud) {
        mNames = names;
