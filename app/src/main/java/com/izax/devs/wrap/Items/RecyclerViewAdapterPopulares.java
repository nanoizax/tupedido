...
public class RecyclerViewAdapterPopulares extends RecyclerView.Adapter<RecyclerViewAdapterPopulares.MyViewHolder> {
    ...
    public RecyclerViewAdapterPopulares(Context mContext, ArrayList images, ArrayList titulo, ArrayList id, ArrayList precio, ArrayList descripcion, ArrayList cantidad, ArrayList latitud, ArrayList longitud) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.cardveiw_item_populares,parent,false);
